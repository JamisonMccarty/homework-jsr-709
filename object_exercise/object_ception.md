...
* Do your work in the `homework.js` file

## The solar system, part 1

The following data structure, `solarSystem`, is a common data structure: an **array** of **objects**. You will see this particular data structure more and more as you venture into JSON. This one is an **array** of **objects** which also contains **arrays**.
